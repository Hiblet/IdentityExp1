...
namespace NZ01
{
    public class JwtIssuerOptions
    {
        ...
        /// <summary>
        /// Set the timespan the access token will be valid for (Access default is 5 min/300 seconds, Refresh default is 10 min)
        /// </summary>
        public TimeSpan AccessValidFor { get; set; } = TimeSpan.FromSeconds(300);
        public TimeSpan RefreshValidFor { get; set; } = TimeSpan.FromSeconds(600);
        ...
        /// <summary>
        /// Token will allow drift from expiration by this many seconds
        /// </summary>
        public UInt32 AccessClockSkew { get; set; } = 5;
        public UInt32 RefreshClockSkew { get; set; } = 5;
    }
}