...
namespace AspNetCoreRateLimit
{
    public class IpRateLimitMiddleware
    {
        ...
        public virtual ClientRequestIdentity SetIdentity(HttpContext httpContext)
        {
            ...
            if (string.IsNullOrWhiteSpace(clientId)) clientId = "anon";
        ...
        {
            var message = string.IsNullOrEmpty(_options.QuotaExceededMessage) ? $"API calls quota exceeded! Maximum {rule.Limit} Requests per {rule.Period}. " : _options.QuotaExceededMessage;
